...
@Component({
  selector: 'app-hlist',
  templateUrl: './hlist.page.html',
  styleUrls: ['./hlist.page.scss'],
})
export class HlistPage implements OnInit {
  characters = [];
  constructor(private http: HttpClient) { }

  ngOnInit() {
    this.http
    .get<any>('https://hp-api.herokuapp.com/api/characters/house/Hufflepuff')
    .subscribe((res) => {
      console.log(res);
      this.characters = res;
