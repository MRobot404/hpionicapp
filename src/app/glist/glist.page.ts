...
@Component({
  selector: 'app-glist',
  templateUrl: './glist.page.html',
  styleUrls: ['./glist.page.scss'],
})
export class GlistPage implements OnInit {
  characters = [];
  constructor(private http: HttpClient) { }
  ngOnInit() {
    this.http
      .get<any>('http://hp-api.herokuapp.com/api/characters/house/gryffindor')
      .subscribe((res) => {
        console.log(res);
        this.characters = res;
