...
@Component({
  selector: 'app-rlist',
  templateUrl: './rlist.page.html',
  styleUrls: ['./rlist.page.scss'],
})
export class RlistPage implements OnInit {
  characters = [];
  constructor(private http: HttpClient) { }

  ngOnInit() {
    this.http
    .get<any>('https://hp-api.herokuapp.com/api/characters/house/Ravenclaw')
    .subscribe((res) => {
      console.log(res);
      this.characters = res;
